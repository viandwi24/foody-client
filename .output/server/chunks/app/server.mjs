import { toRef, isRef, computed, defineAsyncComponent, defineComponent, inject, provide, h as h$2, Suspense, Transition, reactive, Text, resolveComponent, useSSRContext, watch, useSlots, unref, mergeProps, withCtx, renderSlot, createTextVNode, toDisplayString as toDisplayString$1, createVNode, resolveDynamicComponent, getCurrentInstance, onUnmounted, shallowRef, ref, withAsyncContext, toRefs, cloneVNode, Fragment as Fragment$1, onMounted, watchEffect, Teleport, nextTick, toRaw, openBlock, createBlock, createCommentVNode, createElementBlock, renderList, withModifiers, onErrorCaptured, onServerPrefetch, markRaw, normalizeStyle, normalizeClass, createElementVNode, toHandlers, TransitionGroup, createApp, effectScope, isReactive } from 'vue';
import { $fetch as $fetch$1 } from 'ohmyfetch';
import { withoutTrailingSlash, joinURL, hasProtocol, isEqual, withLeadingSlash, parseURL, withBase } from 'ufo';
import { createHooks } from 'hookable';
import { getContext, executeAsync } from 'unctx';
import { RouterView, createMemoryHistory, createRouter } from 'vue-router';
import destr from 'destr';
import { createError as createError$1, sendRedirect, appendHeader } from 'h3';
import { a as useRuntimeConfig$1, d as defuFn, b as defu } from '../nitro/node-server.mjs';
import { isFunction as isFunction$2 } from '@vue/shared';
import { pascalCase } from 'scule';
import { find, html } from 'property-information';
import htmlTags from 'html-tags';
import { ssrRenderComponent, ssrRenderSlot, ssrInterpolate, ssrRenderAttrs, ssrRenderVNode, ssrRenderClass, ssrRenderDynamicModel, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderList, ssrRenderStyle, ssrRenderTeleport, ssrRenderSuspense } from 'vue/server-renderer';
import { hash, isEqual as isEqual$1 } from 'ohash';
...
const layouts = {
  dashboard: defineAsyncComponent(() => import('./_nuxt/dashboard.455cb18b.mjs').then((m2) => m2.default || m2)),
  page: defineAsyncComponent(() => import('./_nuxt/page.b781266b.mjs').then((m2) => m2.default || m2))
};
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/document-driven.1fe5f0f1.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "bak-404",
    path: "/bak/404",
    ...
    component: () => import('./_nuxt/404.2f211342.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "bak-blank",
    path: "/bak/blank",
    ...
    component: () => import('./_nuxt/blank.8b1ba2d9.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "bak-dashboard",
    path: "/bak/dashboard",
    ...
    component: () => import('./_nuxt/index.56ec0b5c.mjs').then((m2) => m2.default || m2)
  },
  {
    ...
    component: () => import('./_nuxt/getting-started.ddb83b14.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "bak-post-slut",
    path: "/bak/post/:slut",
    ...
    component: () => import('./_nuxt/_slut_.b569577b.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "bak-post",
    path: "/bak/post",
    ...
    component: () => import('./_nuxt/index.56d6508b.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "bak-setting",
    path: "/bak/setting",
    ...
    component: () => import('./_nuxt/setting.c9b5fac9.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "bak-test",
    path: "/bak/test",
    ...
    component: () => import('./_nuxt/test.6a44edc0.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import('./_nuxt/index.8a307b8c.mjs').then((m2) => m2.default || m2)
  },
  {
    ...
    component: () => import('./_nuxt/login.96bdab07.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "owner",
    path: "/owner",
    ...
    component: () => import('./_nuxt/index.e904559d.mjs').then((m2) => m2.default || m2)
  }
];
...
const _sfc_main$1 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.69dd0df8.mjs').then((r2) => r2.default || r2));
    const nuxtApp = useNuxtApp();
