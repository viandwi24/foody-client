import { getCurrentInstance, reactive, ref, onServerPrefetch, unref, toRef, isRef, inject, defineComponent, computed, h as h$2, resolveComponent, defineAsyncComponent, shallowRef, watchEffect, markRaw, provide, Suspense, Transition, Text, useSSRContext, watch, useSlots, mergeProps, withCtx, renderSlot, createTextVNode, toDisplayString as toDisplayString$1, createVNode, resolveDynamicComponent, effectScope, onUnmounted, Fragment as Fragment$1, withAsyncContext, toRefs, openBlock, createElementBlock, createElementVNode, cloneVNode, onMounted, nextTick, Teleport, toRaw, createBlock, createCommentVNode, isReactive, renderList, withModifiers, normalizeStyle, normalizeClass, toHandlers, TransitionGroup, onErrorCaptured, createApp } from "vue";
import { $fetch as $fetch$1 } from "ohmyfetch";
import { joinURL, hasProtocol, parseURL, withoutTrailingSlash, withBase, withLeadingSlash, isEqual as isEqual$1 } from "ufo";
...
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderComponent, ssrInterpolate, ssrRenderVNode, ssrRenderClass, ssrRenderDynamicModel, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderTeleport, ssrRenderStyle, ssrRenderList, ssrRenderSuspense } from "vue/server-renderer";
...
const layouts = {
  dashboard: defineAsyncComponent(() => import("./_nuxt/dashboard.455cb18b.js").then((m2) => m2.default || m2)),
  page: defineAsyncComponent(() => import("./_nuxt/page.b781266b.js").then((m2) => m2.default || m2))
};
...
function _$1({ ownerDocument: u2, container: a2, containers: t2, previousActiveElement: r2 }, n2) {
  var o2;
  E((o2 = u2.value) == null ? void 0 : o2.defaultView, "focus", (e2) => {
    if (!n2.value)
      return;
    ...
    if (!i2)
      return;
    let l2 = e2.target;
    l2 && l2 instanceof HTMLElement ? x(s2, l2) ? (r2.value = l2, w$1(l2)) : (e2.preventDefault(), e2.stopPropagation(), w$1(i2)) : w$1(r2.value);
  }, true);
}
function x(u2, a2) {
  var t2;
...
let k = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", Ne = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: k }, initialFocus: { type: Object, default: null } }, emits: { close: (a2) => true }, setup(a$12, { emit: u2, attrs: t2, slots: s$12, expose: i2 }) {
  ...
  let r2 = ref(0), d2 = p$2(), S2 = computed(() => a$12.open === k && d2 !== null ? u$4(d2.value, { [l$2.Open]: true, [l$2.Closed]: false }) : a$12.open), x2 = ref(/* @__PURE__ */ new Set()), m2 = ref(null), B2 = ref(null), I = computed(() => m$2(m2));
  ...
  }, computed(() => f2.value === 0 && !C2.value)), E((A2 = I.value) == null ? void 0 : A2.defaultView, "keydown", (o2) => {
    o2.defaultPrevented || o2.key === o$2.Escape && f2.value === 0 && (C2.value || (o2.preventDefault(), o2.stopPropagation(), O2.close()));
  }), watchEffect((o$12) => {
    var W;
    if (f2.value !== 0 || G2)
      return;
...
const Gem_vue_vue_type_style_index_0_scoped_9fa2f2ec_lang = "";
const _sfc_main$y = {
  data() {
    return {
      ready: false
...
const welcome_vue_vue_type_style_index_0_scoped_94cecdbb_lang = "";
const _sfc_main$3 = {
  __name: "welcome",
  __ssrInlineRender: true,
  props: {
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/document-driven.1fe5f0f1.js").then((m2) => m2.default || m2)
  },
  {
    name: "bak-404",
    path: "/bak/404",
    ...
    component: () => import("./_nuxt/404.2f211342.js").then((m2) => m2.default || m2)
  },
  {
    name: "bak-blank",
    path: "/bak/blank",
    ...
    component: () => import("./_nuxt/blank.8b1ba2d9.js").then((m2) => m2.default || m2)
  },
  {
    name: "bak-dashboard",
    path: "/bak/dashboard",
    ...
    component: () => import("./_nuxt/index.56ec0b5c.js").then((m2) => m2.default || m2)
  },
  {
    ...
    component: () => import("./_nuxt/getting-started.ddb83b14.js").then((m2) => m2.default || m2)
  },
  {
    name: "bak-post-slut",
    path: "/bak/post/:slut",
    ...
    component: () => import("./_nuxt/_slut_.b569577b.js").then((m2) => m2.default || m2)
  },
  {
    name: "bak-post",
    path: "/bak/post",
    ...
    component: () => import("./_nuxt/index.56d6508b.js").then((m2) => m2.default || m2)
  },
  {
    name: "bak-setting",
    path: "/bak/setting",
    ...
    component: () => import("./_nuxt/setting.c9b5fac9.js").then((m2) => m2.default || m2)
  },
  {
    name: "bak-test",
    path: "/bak/test",
    ...
    component: () => import("./_nuxt/test.6a44edc0.js").then((m2) => m2.default || m2)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index.8a307b8c.js").then((m2) => m2.default || m2)
  },
  {
    ...
    component: () => import("./_nuxt/login.96bdab07.js").then((m2) => m2.default || m2)
  },
  {
    name: "owner",
    path: "/owner",
    ...
    component: () => import("./_nuxt/index.e904559d.js").then((m2) => m2.default || m2)
  }
];
...
const _sfc_main$1 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.69dd0df8.js").then((r2) => r2.default || r2));
    const nuxtApp = useNuxtApp();
...
export {
  ...
  _sfc_main$16 as h,
  useI18n as i,
  __nuxt_component_4$1 as j,
  _sfc_main$14 as k,
  __nuxt_component_6 as l,
  __nuxt_component_7 as m,
  _sfc_main$11 as n,
  __nuxt_component_1 as o,
  _sfc_main$Z as p,
  _sfc_main$Y as q,
  __unplugin_components_0$5 as r,
  _sfc_main$X as s,
  _sfc_main$W as t,
  useContent as u,
  __nuxt_component_4 as v,
  _sfc_main$U as w,
  _sfc_main$T as x,
