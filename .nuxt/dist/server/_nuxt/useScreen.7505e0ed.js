import { defineComponent, ref, h, computed, provide, watchEffect, Fragment, onMounted, onUnmounted, inject, reactive } from "vue";
import { B as f, C as a, D as o, V, E as w, F as t, G as b, R, H as o$1, P, M, I as u, J as t$1 } from "../server.mjs";
...
let le = defineComponent({ name: "TabGroup", emits: { change: (a2) => true }, props: { as: { type: [Object, String], default: "template" }, selectedIndex: { type: [Number], default: null }, defaultIndex: { type: [Number], default: 0 }, vertical: { type: [Boolean], default: false }, manual: { type: [Boolean], default: false } }, inheritAttrs: false, setup(a2, { slots: u2, attrs: i, emit: f2 }) {
  ...
  return provide(O, x), watchEffect(() => {
    ...
    return h(Fragment, [o$12.value.length <= 0 && h(d, { onFocus: () => {
      ...
      return false;
    } }), V({ theirProps: { ...i, ...w(a2, ["selectedIndex", "defaultIndex", "manual", "vertical", "onChange"]) }, ourProps: {}, slot: t2, slots: u2, attrs: i, name: "TabGroup" })]);
  };
  ...
  let e = E("Tab"), o$2 = `headlessui-tabs-tab-${t()}`, n = ref(null);
  ...
  function s() {
    var l;
    r.value || (r.value = true, !a2.disabled && ((l = o(n)) == null || l.focus(), e.setSelectedIndex(c.value), t$1(() => {
      r.value = false;
    })));
  }
  function R2(l) {
  ...
  let T = b(computed(() => ({ as: a2.as, type: u$1.type })), n);
  return () => {
    var g;
  ...
  let e = E("TabPanel"), o$12 = `headlessui-tabs-panel-${t()}`, n = ref(null);
...
//# sourceMappingURL=useScreen.7505e0ed.js.map
