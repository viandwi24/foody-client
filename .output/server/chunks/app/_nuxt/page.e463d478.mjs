import { a2 as useState, Q as useCart, O as useLoading, a3 as useApi, S as useSocket, a4 as Api, a0 as _sfc_main$v, a1 as _sfc_main$w, z as _sfc_main$17 } from '../server.mjs';
    ...
    const checkout = async () => {
      ...
      try {
        ...
        if (res.status === 201) {
          ...
          (_a = socket.value) == null ? void 0 : _a.emit("new:order", { data: res.data.data });
          reset();
        }
      } catch (error) {
      }
...
//# sourceMappingURL=page.e463d478.mjs.map
